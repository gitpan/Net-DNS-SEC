# $Id: 66-RRSIG-NSEC3DSA.t 1289 2015-01-05 10:08:59Z willem $	-*-perl-*-
#
...
BEGIN {
	...
	plan skip_all => 'optional Crypt::OpenSSL::DSA not installed'
			unless eval { require Crypt::OpenSSL::DSA; };

	plan tests => 8;

	use_ok('Net::DNS::SEC');

	use_ok('Crypt::OpenSSL::DSA');
}


my $keyfile = 'Knsec3dsa.example.+006+07777.private';
...
NSEC3DSA.example.	3600	IN	DNSKEY	257 3 6 (
...
NSEC3DSA.example.	3600	IN	DNSKEY	256 3 6 (
